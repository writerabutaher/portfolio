        ...
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <form action="https://formsubmit.co/writerabutaher@gmail.com" method='POST' className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full">
                            <button type='submit' className="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">Button</button>
                        </div>
                    </form>
                </div>
            </div>
